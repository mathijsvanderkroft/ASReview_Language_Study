...
setup(
    ...
    entry_points={
        ...
        'asreview.models.feature_extraction': [
            ...
            'fasttext_EN = asreview.models.feature_extraction:FastText_EN',
            'fasttext_DE = asreview.models.feature_extraction:FastText_DE',
            'fasttext_ES = asreview.models.feature_extraction:FastText_ES',
            'fasttext_TR = asreview.models.feature_extraction:FastText_TR',
            'multilingual_pre = asreview.models.feature_extraction:MultilingualSentenceTransformer_pre',
            'multilingual_post_EN = asreview.models.feature_extraction:MultilingualSentenceTransformer_post_EN',
            'multilingual_post_DE = asreview.models.feature_extraction:MultilingualSentenceTransformer_post_DE',
            'multilingual_post_ES = asreview.models.feature_extraction:MultilingualSentenceTransformer_post_ES',
            'multilingual_post_TR = asreview.models.feature_extraction:MultilingualSentenceTransformer_post_TR',
            'multilingual_post_DE_EN = asreview.models.feature_extraction:MultilingualSentenceTransformer_post_DE_EN',
            'multilingual_post_ES_EN = asreview.models.feature_extraction:MultilingualSentenceTransformer_post_ES_EN',
            'multilingual_post_TR_EN = asreview.models.feature_extraction:MultilingualSentenceTransformer_post_TR_EN',
            'tfidf = asreview.models.feature_extraction:Tfidf',
            'tfidf_EN = asreview.models.feature_extraction:Tfidf_EN',
            'tfidf_DE = asreview.models.feature_extraction:Tfidf_DE',
            'tfidf_ES = asreview.models.feature_extraction:Tfidf_ES',
            'tfidf_TR = asreview.models.feature_extraction:Tfidf_TR',
        ],
