...
class MultilingualSentenceTransformer_post_TR(BaseFeatureExtraction):
    ...
    name = "multilingual_post_TR"
    label = "Multilingual Sentence Transformer that just loads a previously saved Turkish feature matrix"

    def transform(self, texts):

        X = np.load(r'C:\Users\mijnn\Desktop\Data_Science\Thesis\language_study\sbert_model_TR.npy')
        return X
