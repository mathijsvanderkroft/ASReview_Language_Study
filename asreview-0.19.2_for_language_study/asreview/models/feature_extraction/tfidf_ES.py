...
class Tfidf_ES(BaseFeatureExtraction):
    ...
    def __init__(self, *args, ngram_max=1, stop_words="spanish", **kwargs):
        """Initialize tfidf class.
        """
        super(Tfidf_ES, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Tfidf_ES, self).full_hyper_space()
