...
class Tfidf_TR(BaseFeatureExtraction):
    ...
    def __init__(self, *args, ngram_max=1, stop_words="turkish", **kwargs):
        """Initialize tfidf class.
        """
        super(Tfidf_TR, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Tfidf_TR, self).full_hyper_space()
