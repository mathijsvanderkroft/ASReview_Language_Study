...
class MultilingualSentenceTransformer_post_DE_EN(BaseFeatureExtraction):
    ...
    name = "multilingual_post_DE_EN"
    label = "Multilingual Sentence Transformer that just loads a previously saved English feature matrix"

    def transform(self, texts):

        X = np.load(r'C:\Users\mijnn\Desktop\Data_Science\Thesis\language_study\sbert_model_DE_EN.npy')
        return X
