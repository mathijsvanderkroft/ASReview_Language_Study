...
class MultilingualSentenceTransformer_post_DE(BaseFeatureExtraction):
    ...
    name = "multilingual_post_DE"
    label = "Multilingual Sentence Transformer that just loads a previously saved German feature matrix"

    def transform(self, texts):

        X = np.load(r'C:\Users\mijnn\Desktop\Data_Science\Thesis\language_study\sbert_model_DE.npy')
        return X
